...
#
# Example usage:
# `python sort-by-creation-date.py --folder="./music"`
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Sort audio files (MP3/WAV) into year-named folders based on their creation date.')
    parser.add_argument('--folder', required=True, help='Path to the folder containing your audio files')
